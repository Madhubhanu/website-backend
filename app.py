...
SMTP_PORT = 587
RECIPIENT_EMAIL = "kavyar@genepowerx.com" # Change this to your required email
...
def generate_excel():
    ...
    try:
        ...
        recipient_emails = ["balaji@genepowerx.com","madhu@genepowerx.com","sravani@genepowerx.com","srujana@genepowerx.com","kavyar@genepowerx.com"]
